...
const meta: Meta<typeof Avatar> = {
  ...
  argTypes: {
    asChild: {
      ...
      description:
        'Slot을 통해 Avatar 스타일을 다른 태그에 이식하여 Avatar 스타일을 적용할 때 사용하실 수 있습니다. 다만 제한이 있을 수 있으니 유의해 주세요.',
    },
    size: {
      control: 'select',
      options: sizeArr,
      ...
      description:
        '아바타의 크기를 지정하는 props 로써, [small, basic, medium, large, fit] 중에서 선택하실 수 있습니다.',
    },
    shape: {
      control: 'select',
      options: shapeArr,
      table: { type: { summary: 'string' }, defaultValue: { summary: 'round' } },
      description: '아바타의 모양을 지정하는 props 로써, [round, square] 중에서 선택하실 수 있습니다.',
    },
    src: {
      control: 'text',
      table: { type: { summary: 'string' }, defaultValue: { summary: '/images/avatar-jira.png' } },
      description:
        '아바타로 사용할 이미지의 경로(URL, 상대경로, base64 등) 로서 스토리북에서는 임의로 기본값을 "/images/avatar-jira.png" 를 처리하였습니다.',
    },
    alt: {
      control: 'text',
      table: { type: { summary: 'string' }, defaultValue: { summary: 'AvatarAlt' } },
      description: '아바타로 사용할 이미지의 대체 텍스트',
    },
    fallback: {
      control: 'text',
      table: { type: { summary: 'string' }, defaultValue: { summary: 'AvatarFallback' } },
      description:
        '이미지가 없거나 로딩 실패 시 보여줄 대체 UI(텍스트, 아이콘 등)로서 fallback 미지정 시 기본 아이콘(UserFilledIcon)이 표시되고, fallback 지정 시 해당 텍스트가 표기됩니다.',
    },
    delayMs: {
      control: 'number',
      table: { type: { summary: 'number' }, defaultValue: { summary: '700' } },
      description:
        'fallback이 나타나기까지 기다리는 시간(ms)으로서 fallback(대체 UI)이 너무 빨리 깜빡이며 나타나는 현상(플래시)을 방지하기 위해 UX 개선 목적으로 사용합니다.',
    },
    onLoadingStatusChange: {
      control: false,
      action: 'onLoadingStatusChange',
      table: {
        type: { summary: '(status: AvatarLoadingStatus) => void | undefined' },
        defaultValue: { summary: 'undefined' },
      },
      description:
        '이미지 로딩 상태 변화 시 호출되는 콜백으로서 상태에 따라 콜백 처리 가능합니다. 상태인 AvatarLoadingStatus 는 [idle | loading | loaded | error] 가 있습니다.',
    },
    disabled: {
      control: 'boolean',
      table: { type: { summary: 'boolean' }, defaultValue: { summary: 'false' } },
    ...
    children: {
      ...
      options: tagArr,
      table: { disable: true },
      description: 'children 으로써 asChild 때 들어갈 자식 노드 입니다.',
    },
  },
  parameters: {
    docs: {
...
export const Size: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'size 값에 따른 Avatar의 다양한 크기별 예시입니다.',
      },
    },
  },
  render: (args) => (
...
export const Shape: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'shape 값에 따른 Avatar의 다양한 모양별 예시입니다. 안의 이미지 크기와 별도로 배경색을 추가하였으므로 모양을 확인하실 수 있습니다.',
      },
    },
  },
  render: (args) => (
...
export const Src: Story = {
  argTypes: {
    ...
    src: {
      control: 'select',
      options: srcArr,
      table: { type: { summary: 'string' }, disable: false },
    },
  },
  parameters: {
    docs: {
      description: {
        story: 'src 값에 따른 Avatar의 다양한 이미지 별 예시입니다.',
      },
    },
  },
  render: (args) => (
...
export const Status: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'delayMs 값에 따른 Avatar의 로딩되는 상태에 대한 Mock 예시입니다. <br/>delayMs와 onLoadingStatusChange를 활용하여 Avatar의 이미지 로딩 상태 변화를 확인할 수 있습니다. <br/>delayMs를 조정해보고, 각 src 별로 상태 변화 로그를 확인해보실 수 있습니다.',
      },
    },
  },
