...
const meta: Meta<typeof DropdownMenu> = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          '사용자에게 선택 옵션 목록을 제공하는 다용도 드롭다운 메뉴 컴포넌트입니다. `options` prop을 통해 동적으로 메뉴를 생성하거나, 자식 요소를 직접 구성하여 커스텀 메뉴를 만들 수 있습니다.',
      },
    },
  },
  argTypes: {
    align: {
      ...
      description: '트리거 기준 드롭다운의 가로 정렬을 설정합니다.',
    },
    side: {
      control: 'select',
      options: ['top', 'right', 'bottom', 'left'],
      description: '트리거 기준 드롭다운이 나타날 방향을 설정합니다.',
    },
    size: {
      control: 'number',
...
export const PlacementOptions: Story = {
  ...
  // 이 스토리에서는 render 함수가 side와 align을 직접 제어하므로,
